...
def parse_arguments():
    ...
    parser.add_argument("--last_loss", default=None, type=float)
...
def main(args):
    ...
    if args.use_last:
        model.load_state_dict(torch.load(f"{args.name}_best.pth"))
    ...
    if args.last_loss is not None:
        best_val_loss = args.last_loss
    else:
...
if __name__ == '__main__':
    ...
    assert(args.use_last or args.last_loss is None)
    sys.exit(main(args))
